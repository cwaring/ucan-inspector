...
import DelegationChainList from './inspector/DelegationChainList.vue'
import InspectorDebugPanel from './inspector/InspectorDebugPanel.vue'
import InspectorInputPanel from './inspector/InspectorInputPanel.vue'
import InspectorResultsHeader from './inspector/InspectorResultsHeader.vue'
import ReportExportControls from './inspector/ReportExportControls.vue'
import TokenDetailsTabs from './inspector/TokenDetailsTabs.vue'
import TokenOverview from './inspector/TokenOverview.vue'
